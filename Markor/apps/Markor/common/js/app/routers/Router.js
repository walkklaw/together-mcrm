  ...
  var Router = Backbone.Router.extend({
    ...
    changePage : function(page) {
      ...
      function success() {
        ...
        var transition = (options && options.transition) || "slide";
      ...
      if(Config.IS_LOCAL){
        ...
        Helpers.connectionHandler(errMsgs && errMsgs.network, success, 
    ...
    back : function(backPage) {
      ...
      var naviOpts;
      var transition = (context && context.transition) || "slide";
